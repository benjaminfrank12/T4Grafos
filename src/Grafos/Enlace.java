...
public class Enlace {
 ...
 private String nombre;   //modificaciones del autor benjamin
    ...
    public Enlace(int x1, int y1, int x2, int y2,String nombre){   //modificaciones del autor benjamin) 
        this.x1 = x1;
        this.y1 = y1;
        this.x2 = x2;
        this.y2 = y2;
        this.nombre=nombre; //modificaciones del autor benjamin
    }
 
    public void pintar(Graphics g){
        g.drawLine(x1, y1, x2, y2);
        if(x1>x2 && y1>y2){     //modificaciones del autor benjamin de aqui
        ...
        }   //modificaciones del autor benjamin hasta aqui
    }
