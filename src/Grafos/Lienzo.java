...
public void paint(Graphics g){
    ...
    public void mouseClicked(MouseEvent e) {
      if(e.getButton()==MouseEvent.BUTTON1){
          String nombre=JOptionPane.showInputDialog("Introduce el nombre del nodo: ");  //modificaciones del autor benjamin
          ...
          for(Nodo nodo:vectorNodos){
            if(new Rectangle(nodo.getX()-Nodo.d/2,nodo.getY()-Nodo.d/2,Nodo.d,Nodo.d).contains(e.getPoint()));{
              if(p1==null)
                  ...
                  String nombre=JOptionPane.showInputDialog("Introduce el nombre del nodo: ");  //modificaciones del autor benjamin
                  this.vectorEnlaces.add(new Enlace(p1.x,p1.y,p2.x,p2.y, nombre));   //modificaciones del autor benjamin
                  repaint();
                  p1=null;
                  p2=null;
          }
